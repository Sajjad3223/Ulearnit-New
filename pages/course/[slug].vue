...
<div>
  <header class="w-full">
    <div class="flex items-center justify-between container mx-auto my-6">
      ...
      <div class="bg-[#D9D9D9]/10 p-4 px-6 rounded-lg flex font-light items-center gap-12">
        <NuxtLink to="/" class="opacity-50">
          صفحه اصلی
        </NuxtLink>
        <NuxtLink to="/" class="opacity-100 font-semibold">
          دوره ها
        </NuxtLink>
        <NuxtLink to="/" class="opacity-50">
          تماس با ما
      ...
      <button class="relative group grid w-max place-items-center">
        <svg class="absolute transition-all duration-200 text-white group-hover:text-indigo-600" width="178" height="57" viewBox="0 0 178 57" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="paint0_linear_1570_789" x1="89" y1="57" x2="89" y2="-7.2381" gradientUnits="userSpaceOnUse">
        ...
        <span class="flex items-center gap-3">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.79561 4L5.10749 4C4.54855 4 4.0125 4.21071 3.61727 4.58579C3.22204 4.96086 3 5.46957 3 6V18C3 18.5304 3.22204 19.0391 3.61727 19.4142C4.0125 19.7893 4.54855 20 5.1075 20H8.79561M21 12.0011H9.05754M9.05754 12.0011L13.6207 16.5725M9.05754 12.0011L13.6207 7.42969" stroke="#F9FAFB" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <span>
          ورود / ثبت نام
        </span>
  ...
  <main>
    <div class="absolute inset-x-0 h-auto top-0 -z-10 grid place-items-center">
      <img src="~/assets/images/unity-banner.png" alt="unity bannerr" class="w-full h-full max-h-screen object-cover ">
      <div class="absolute inset-0" style="background-image: linear-gradient(180deg, rgba(9, 13, 22, 0) 0%, rgba(9,13,22,0.5) 90%);">
      </div>
      <div class="absolute bottom-12 right-[10vw] flex flex-col space-y-8">
        <h2 class="text-5xl font-lalezar">نام دوره انتخاب شده</h2>
        <span class="text-lg font-light">دوره جامع یونیتی شخصیت سازی</span>
          ...
          <div class="flex-1 flex flex-col">
            ...
            <ul id="episodes" class="flex flex-col space-y-5">
              <li class="overflow-hidden">
                <div class="season-expander border-transparent" @click="expandSeason"
                ...
                <ul class="details overflow-hidden" >
                  <li class="px-10 transition-shadow duration-300 border-b border-b-indigo-500/50">
                    <div class=" py-8 episode-expander" @click="expandEpisode">
                      <span class="text-indigo-400 text-sm font-thin pointer-events-none">1 قسمت اول</span>
                      <strong class="pointer-events-none">شروع شخصیت سازی</strong>
                      <small class="pointer-events-none">03:56:05</small>
                  ...
                  <li class="px-10 transition-shadow duration-300 border-b border-b-indigo-500/50">
                    <div class=" py-8 episode-expander" @click="expandEpisode">
                      <span class="text-indigo-400 text-sm font-thin pointer-events-none">2 قسمت دوم</span>
                      <strong class="pointer-events-none">شروع شخصیت سازی</strong>
                      <small class="pointer-events-none">03:56:05</small>
                      <button class="relative group grid place-items-center p-2 transition-colors duration-200 rounded-lg hover:bg-white/5">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="px-10 transition-shadow duration-300 border-b border-b-indigo-500/50">
                    <div class=" py-8 episode-expander" @click="expandEpisode">
                      <span class="text-indigo-400 text-sm font-thin pointer-events-none">3 قسمت سوم</span>
                      <strong class="pointer-events-none">شروع شخصیت سازی</strong>
                      <small class="pointer-events-none">03:56:05</small>
                      <button class="relative group grid place-items-center p-2 transition-colors duration-200 rounded-lg hover:bg-white/5">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="px-10 transition-shadow duration-300 ">
                    <div class=" py-8 episode-expander" @click="expandEpisode">
                      <span class="text-indigo-400 text-sm font-thin pointer-events-none">4 قسمت چهارم</span>
                      <strong class="pointer-events-none">شروع شخصیت سازی</strong>
                      <small class="pointer-events-none">03:56:05</small>
                      <button class="relative group grid place-items-center p-2 transition-colors duration-200 rounded-lg hover:bg-white/5">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li class="py-8 px-10 text-black border-b border-black/10 bg-[#D0D7EA]">
                    <div class="grid grid-cols-6 items-center w-full gap-4">
                      ...
                      <strong class="mx-auto col-span-3">
                        آزمون شخصیت سازی
                      </strong>
                  ...
                  <li class="py-8 px-10 rounded-b-xl text-black bg-[#D0D7EA]">
                    <div class="grid grid-cols-6 items-center w-full gap-4">
                      <div class="flex items-center gap-4 col-span-2">
                        <span>
                        2 کوییز دوم
                      </span>
                      <span class="bg-[#91ACFF] text-white border border-[#91ACFF] rounded-lg text-[10px] p-2 py-1">15 سؤال</span>
                      <div class="bg-[#F51940]/20 border border-[#F51940] rounded-md flex items-center gap-1 text-[#F51940] p-2 py-1">
                        <small class="text-[10px]">متوسط</small>
                      </div>
                      </div>
                      <strong class="mx-auto col-span-3">
                        آزمون شخصیت سازی (2)
              ...
              <li class="overflow-hidden">
                <div class="season-expander border-transparent" @click="expandSeason"
                  ...
                  <span class="bg-[#25324D] border border-[#25324D] pointer-events-none rounded-lg text-[10px] p-2">5 قسمت - 2 آزمون</span>
                  <div class="bg-[#F51940]/20 border border-[#F51940] rounded-md flex items-center gap-1 text-[#F51940] p-2">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M10.9498 6.29837V4.86704C10.9498 3.1917 9.59114 1.83304 7.91581 1.83304C6.24047 1.8257 4.87647 3.1777 4.86914 4.8537V4.86704V6.29837" stroke="#F51940" stroke-linecap="round" stroke-linejoin="round"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M10.456 14.1663H5.36198C3.96598 14.1663 2.83398 13.035 2.83398 11.6383V8.77898C2.83398 7.38231 3.96598 6.25098 5.36198 6.25098H10.456C11.852 6.25098 12.984 7.38231 12.984 8.77898V11.6383C12.984 13.035 11.852 14.1663 10.456 14.1663Z" stroke="#F51940" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M7.90951 9.46875V10.9494" stroke="#F51940" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <small class="text-[10px]">ابتدا آزمون فصل قبل را انجام دهید</small>
                  </div>
                  <div class="mr-auto pointer-events-none">
                    <span>03:56:05</span>
                  </div>
              ...
              <li class="overflow-hidden">
                <div class="season-expander border-transparent" @click="expandSeason"
                     style="box-shadow: 0 5px 20px rgba(7, 10, 17, 0.63);">
                  <strong class="pointer-events-none">
                    فصل سوم - ساخت چند شخصیت برای بازی
                  </strong>
                  <span class="bg-[#25324D] border border-[#25324D] pointer-events-none rounded-lg text-[10px] p-2">5 قسمت - 2 آزمون</span>
                  <div class="bg-[#F51940]/20 border border-[#F51940] rounded-md flex items-center gap-1 text-[#F51940] p-2">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li class="overflow-hidden">
                <div class="season-expander border-transparent" @click="expandSeason"
                     style="box-shadow: 0 5px 20px rgba(7, 10, 17, 0.63);">
                  <strong class="pointer-events-none">
                    فصل چهارم - ساخت چند شخصیت برای بازی
                  </strong>
                  <span class="bg-[#25324D] border border-[#25324D] pointer-events-none rounded-lg text-[10px] p-2">5 قسمت - 2 آزمون</span>
                  <div class="bg-[#F51940]/20 border border-[#F51940] rounded-md flex items-center gap-1 text-[#F51940] p-2">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex items-end justify-between w-full">
              <div class="flex flex-col items-start space-y-4">
                <strong class="text-xl">نظرات</strong>
                <div class="flex items-center gap-4">
              ...
              <button class="border rounded-lg border-white/20 px-8 py-1 text-white/70">
                + ثبت نظر
              </button>
            </div>
            <ul class="p-10 border rounded-3xl mt-6 border-white/10 flex flex-col space-y-8">
              <li class="flex items-start py-4 px-8 border border-white/10 bg-[#111723] rounded-3xl gap-5" v-for="i in 5">
