          ...
          <div class="flex items-start gap-16 mt-10">
            <main class="flex-1 flex flex-col">
              <div class="relative grid place-items-center">
                ...
                <button class="absolute bottom-16 left-16">
              ...
              <div class="flex flex-col space-y-5 mt-8">
                ...
                <div class="flex items-center mr-auto gap-4">
                  <button class="px-3 py-2 rounded-md w-max text-white bg-[#222E49] flex items-center gap-2 text-xs">
                  ...
                  <button class="px-3 py-2 rounded-md w-max text-white bg-indigo-600 flex items-center gap-2 text-xs">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
