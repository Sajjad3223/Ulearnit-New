...
<template>
  <li class="flex items-center justify-between p-4 bg-white/10 rounded-lg">
    <div class="flex items-center gap-2">
      <span class="w-5 h-5 text-xs rounded-full flex items-center justify-center bg-black/30 pt-1">{{index + 1}}</span>
      <span>آزمون اول:مقدمات آنریل انجین</span>
    </div>
    <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">20 سوال</span>
    <span class="bg-blue-100 text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">آسان</span>
    <div class="flex items-center gap-4">
      <button class="p-1 rounded-md bg-white/10 text-white hover:bg-white/30 duration-300 transition-colors">
      ...
      <button class="p-1 rounded-md bg-yellow-400/10 text-yellow-400 hover:bg-yellow-400/30 duration-300 transition-colors">
        <svg class="w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button class="p-1 rounded-md bg-red-400/10 text-red-400 hover:bg-red-400/30 duration-300 transition-colors">
        <svg class="w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
